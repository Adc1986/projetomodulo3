...
namespace ProjetoMVC
{
    public class ContatoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Emails,Telefones")] Contato contato)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Emails,Telefones")] Contato contato)
        {
            if (id != contato.Id)
            {
                return NotFound();
