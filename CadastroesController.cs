...
namespace ProjetoMVC
{
    public class CadastroesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NomeCompleto,CPF,DataNascimento,Email,Telefone")] Cadastro cadastro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NomeCompleto,CPF,DataNascimento,Email,Telefone")] Cadastro cadastro)
        {
            if (id != cadastro.Id)
            {
                return NotFound();
